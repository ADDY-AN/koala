...
export default function GetInvolvedPage() {
    ...
    // Handle Form Submission with GSAP Success Animation
    const handleSubmit = async (e: React.FormEvent) => {
        e.preventDefault();

        // Button loading bounce
        ...
        <main ref={container} className="min-h-screen bg-background relative overflow-hidden pt-24 pb-20">
            ...
            <section className="roles-section px-5 max-w-6xl mx-auto mb-32">
                <div className="grid md:grid-cols-3 gap-8">
                    {/* Role 1: NGO Interns */}
                    <div className="role-card bg-white p-8 rounded-3xl shadow-lg border border-border hover:border-secondary transition-colors group cursor-default">
                        <div className="w-16 h-16 bg-primary/10 rounded-2xl flex items-center justify-center mb-6 group-hover:bg-primary group-hover:text-white transition-colors text-primary">
                            <GraduationCap size={32} />
                        </div>
                        <h3 className="text-2xl font-black font-playfair text-foreground mb-3">College Interns</h3>
                        <p className="text-muted-foreground mb-4 text-sm leading-relaxed">
                            Complete your social internship hours by running awareness campaigns, managing social media, and assisting at screening camps.
                        </p>
                        <ul className="text-sm font-bold text-primary space-y-2">
                            <li>✓ Verified NGO Certificate</li>
                    ...
                    <div className="role-card bg-primary text-primary-foreground p-8 rounded-3xl shadow-xl transform md:-translate-y-4">
                        <div className="w-16 h-16 bg-white/20 rounded-2xl flex items-center justify-center mb-6 text-secondary">
                            <Users size={32} />
                        </div>
                        ...
                        <p className="text-primary-foreground/80 mb-4 text-sm leading-relaxed">
                            Help us with on-ground event support, community outreach, and fundraising activities in Bhagalpur.
                        </p>
                        <ul className="text-sm font-bold text-secondary space-y-2">
                    ...
                    {/* Role 3: CSR & Partners */}
                    <div className="role-card bg-white p-8 rounded-3xl shadow-lg border border-border hover:border-secondary transition-colors group cursor-default">
                        <div className="w-16 h-16 bg-secondary/20 rounded-2xl flex items-center justify-center mb-6 group-hover:bg-secondary transition-colors text-secondary-foreground">
                            <Briefcase size={32} />
                        </div>
                        <h3 className="text-2xl font-black font-playfair text-foreground mb-3">CSR Partnerships</h3>
                        <p className="text-muted-foreground mb-4 text-sm leading-relaxed">
                            For local businesses and SMEs. Partner with us to sponsor therapy sessions and build a legacy of inclusive child healthcare.
                        </p>
                        <ul className="text-sm font-bold text-secondary-foreground space-y-2">
                            <li>✓ 80G Tax Benefits</li>
            ...
            <section className="form-container px-5 max-w-3xl mx-auto perspective-[1000px]">
                <Card className="form-section border-t-[12px] border-t-primary shadow-[0_20px_60px_rgba(45,80,22,0.1)] rounded-[40px] overflow-hidden bg-white relative">
                    {/* Decorative side accent */}
                    <div className="absolute top-0 right-0 w-32 h-full bg-gradient-to-l from-muted to-transparent opacity-50 pointer-events-none" />
                        ...
                        {status === "success" ? (
                            <div className="success-message text-center py-10">
                                ...
                                <p className="text-lg text-muted-foreground font-lato">
                                    Your details have been securely saved. Our coordination team will reach out to you on WhatsApp or Email shortly.
                                </p>
                            </div>
                        ) : (
                            <form onSubmit={handleSubmit} className="space-y-8 relative z-10">
                                ...
                                <div className="space-y-3">
                                    ...
                                    <Input
                                        ...
                                        className="h-14 rounded-2xl bg-muted/30 border-border focus-visible:ring-secondary text-base px-5"
                                    />
                                </div>
                                ...
                                <div className="space-y-3">
                                    ...
                                    <Input
                                        required
                                        placeholder="e.g. College Internship, CSR Funding, Weekend Volunteer"
                                ...
                                <Button
                                    ...
                                    className="submit-btn w-full h-16 rounded-2xl text-xl font-bold bg-primary text-primary-foreground hover:bg-primary/90 shadow-xl shadow-primary/20 mt-4"
                                >
